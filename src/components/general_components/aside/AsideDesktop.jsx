...
const AsideDesktop = () => {
  return (
    <AsideDesktopStyle>
        ...
        <ElementAside to={'/profile/favorites'}>
            <IconAside>
                <svg width='20px' viewBox="0 0 24 24">
        ...
        <ElementAside to={'/profile/social'}>
            <IconAside>
                <svg width='20px' viewBox="0 0 24 24">
